...
import org.apache.velocity.spi.loaders.resources.DataSourceResource;

public class DataSourceLoader extends BaseLoader {
  ...
  protected Resource doLoad(String name, Locale locale, String encoding, String path) throws IOException {
    return new DataSourceResource(engine, name, locale, encoding, 0);
  }
